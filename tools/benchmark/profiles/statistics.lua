...
profile.benchmark_options:add_permutation('library', { libraries.v3d })
profile.benchmark_options:add_permutation('library_flags', {
	{ statistics = true, },
	{ depth_test = false, statistics = true, },
	{ fragment_shader = true, statistics = true }
})
...
function profile.row_sorter(rd1, rd2)
	...
	return rd1.triangles < rd2.triangles or rd1.triangles == rd2.triangles and (s1 < s2 or s1 == s2 and rd1.model.id < rd2.model.id)
end
