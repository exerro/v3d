...
local nearest_image_view = v3d.image_view(nearest_image)
v3d.image_view_set_pixel(nearest_image_view, 0, 0, 0, { 'a', 1 })
v3d.image_view_set_pixel(nearest_image_view, 1, 0, 0, { 'b', 2 })

local linear_image = v3d.create_image(linear_sampler_format, 2, 1, 1)
local linear_image_view = v3d.image_view(linear_image)
v3d.image_view_set_pixel(linear_image_view, 0, 0, 0, { 10.0, 30.0 })
v3d.image_view_set_pixel(linear_image_view, 1, 0, 0, { 20.0, 40.0 })
